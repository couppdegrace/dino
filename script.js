...
function setDinoLose() {
  dino.src = "https://github.com/wasimreja/chrome-dino-game/blob/main/assets/dino-lose.png?raw=true";
}

function handleRun(delta, speedScale) {
  if (isJumping) {
    dino.src = "https://github.com/wasimreja/chrome-dino-game/blob/main/assets/dino-stationary.png?raw=true";
    return;
  }

  if (currentFrameTime >= FRAME_TIME) {
    dinoFrame = (dinoFrame + 1) % DINO_FRAME_COUNT;
    dino.src = `https://github.com/wasimreja/chrome-dino-game/blob/main/assets/dino-run-0.png?raw=true`; /* switch between images to simulate movement */
...
function createCactus() {
  ...
  cactus.src = "https://github.com/wasimreja/chrome-dino-game/blob/main/assets/cactus.png?raw=true";
